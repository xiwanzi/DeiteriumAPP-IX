...
**2.0.8 候选已完成，尚未上线。** App 20800 内置默认弧线 D 与双子节活动图标，新增管理网页切换和在线 / 启动补同步。见 [候选交付](deployment/deuterium-2.0.8-candidate.md)、[本次验收](qa/launcher-icons-v208.md)。下方 2.0.7 为仍有效的已发布记录。
