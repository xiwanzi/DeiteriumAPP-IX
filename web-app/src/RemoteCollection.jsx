...
export default function RemoteCollection({ client, path, user, onNotificationTarget, navigate }) {
  ...
  return <>
    ...
    {editor&&<Modal title={editor.listingId?"编辑玩家商品":"发布玩家商品"} close={()=>setEditor(null)} wide><ListingForm client={client} user={user} initial={editor} onSaved={async()=>{setEditor(null);await load();}}/></Modal>}
