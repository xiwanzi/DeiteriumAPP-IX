import { Store, Gavel, Megaphone, ChartNoAxesCombined, Mail, Server, Sparkles, Users, Smartphone, Ticket, Monitor, ShieldCheck } from "lucide-react";
...
export function adminNavigation(permissions = []) {
  ...
  return [
    ...
    ...(all ? [["/admin?section=whitelist", "白名单管理", ShieldCheck]] : []),
