...
public class XConomyAPI {
    ...
    public int changePlayerBalance(UUID u, String playername, BigDecimal amount, Boolean isadd, String pluginname) {
        ...
        } catch (me.yic.xconomy.deuterium.FundsFailure failure) {
            if (failure.code().equals("INSUFFICIENT_BALANCE")) return 2;
            if (failure.code().equals("MAX_BALANCE_EXCEEDED")) return 3;
            return 1;
        }
        return 0;
    }
