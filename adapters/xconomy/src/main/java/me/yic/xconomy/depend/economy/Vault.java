...
public class Vault extends AbstractEconomy {
    ...
    public EconomyResponse depositPlayer(String name, double amount) {
        ...
        try {
            bal = DataCon.changeplayerdata("PLUGIN", pd.getUniqueId(), amountFormatted, true, null, null).doubleValue();
        } catch (RuntimeException failure) {
            return new EconomyResponse(0.0D, bal, EconomyResponse.ResponseType.FAILURE, "Committed balance operation failed or requires reconciliation");
        }
        return new EconomyResponse(amount, bal, EconomyResponse.ResponseType.SUCCESS, "");
    }
    ...
    public EconomyResponse depositPlayer(OfflinePlayer pp, double amount) {
        ...
        try {
            bal = DataCon.changeplayerdata("PLUGIN", pp.getUniqueId(), amountFormatted, true, null, null).doubleValue();
        } catch (RuntimeException failure) {
            return new EconomyResponse(0.0D, bal, EconomyResponse.ResponseType.FAILURE, "Committed balance operation failed or requires reconciliation");
        }
        return new EconomyResponse(amount, bal, EconomyResponse.ResponseType.SUCCESS, "");
    ...
    public EconomyResponse withdrawPlayer(String name, double amount) {
        ...
        try {
            bal = DataCon.changeplayerdata("PLUGIN", pd.getUniqueId(), amountFormatted, false, null, null).doubleValue();
        } catch (RuntimeException failure) {
            return new EconomyResponse(0.0D, bal, EconomyResponse.ResponseType.FAILURE, "Committed balance operation failed or requires reconciliation");
        }
        return new EconomyResponse(amount, bal, EconomyResponse.ResponseType.SUCCESS, "");
    ...
    public EconomyResponse withdrawPlayer(OfflinePlayer pp, double amount) {
        ...
        try {
            bal = DataCon.changeplayerdata("PLUGIN", pp.getUniqueId(), amountFormatted, false, null, null).doubleValue();
        } catch (RuntimeException failure) {
            return new EconomyResponse(0.0D, bal, EconomyResponse.ResponseType.FAILURE, "Committed balance operation failed or requires reconciliation");
        }
        return new EconomyResponse(amount, bal, EconomyResponse.ResponseType.SUCCESS, "");
