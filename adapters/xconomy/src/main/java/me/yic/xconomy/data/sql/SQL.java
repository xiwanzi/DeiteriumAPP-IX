...
public class SQL {
    ...
    public static void save(PlayerData pd, Boolean isAdd, BigDecimal amount, RecordInfo ri) {
        me.yic.xconomy.deuterium.ControlledEconomyAPI.nativeChange(pd.getUniqueId(), amount, isAdd,
                ri == null ? "LEGACY_SQL" : ri.getType(), ri == null ? "" : ri.getCommand());
    }
    ...
    public static void saveall(String targettype, List<UUID> players, BigDecimal amount, Boolean isAdd,
                               RecordInfo ri) {
        me.yic.xconomy.deuterium.ControlledEconomyAPI.nativeBulk(targettype.equalsIgnoreCase("all") ? null : players,
                amount, isAdd, ri == null ? "LEGACY_SQL" : ri.getType(), ri == null ? "" : ri.getCommand());
    }
    ...
    public static void deletePlayerData(String UUID) {
        me.yic.xconomy.deuterium.ControlledEconomyAPI.deleteAccount(java.util.UUID.fromString(UUID));
    }
