...
public class RedisConnection {
    ...
    public static void close() {
        me.yic.xconomy.data.redis.RedisThread.shutdown();
        // shutdown already unsubscribed and closed its socket; a second
        // unsubscribe would attempt to flush a closed Redis connection.
        if (jedis != null) {
            if (!jedis.isClosed()) {
                jedis.close();
            }
